...
* practitioner.reference ^definition = "La referencia es una URI comúnmente, la cual hace referencia al Prestador en cuestion"	
...
* organization.reference ^definition = "La referencia es una URI comúnmente, la cual hace referencia al organización en cuestion"	
...
* location.reference ^definition = "La referencia es una URI comúnmente, la cual hace referencia a la ubicación en cuestion"	
