...
* identifier.type ^comment = "De haber RUN, este se debe usar. De haber Run temporal, se debe usar ese identificador. Pacientes sin identificador chileno deben usar su CI o Pasaporte de origen. Pacientes sin identificación se debe registrar con el número de registro clínico generado en el recinto de salud"
